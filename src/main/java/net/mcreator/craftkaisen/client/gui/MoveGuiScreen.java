...
public class MoveGuiScreen extends AbstractContainerScreen<MoveGuiMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack,
				...
				ReturnTechniqueProcedure.execute(entity), 26, 7, -9868951);
		this.font.draw(poseStack,

				ReturnMoveDisplayProcedure.execute(entity), 17, 25, -3434702);
		this.font.draw(poseStack,

				ReturnMoveCostProcedure.execute(entity), 8, 43, -12829636);
		this.font.draw(poseStack,

				ReturnSkillpointsProcedure.execute(), 8, 142, -12829636);
	}
