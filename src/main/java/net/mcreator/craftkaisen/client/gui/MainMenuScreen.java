...
public class MainMenuScreen extends AbstractContainerScreen<MainMenuMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack,
				...
				ReturnSkillpointsProcedure.execute(), -3, -56, -12829636);
		if (
		...
		this.font.draw(poseStack,
				...
				ReturnAffiliationProcedure.execute(), -3, -29, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.craft_kaisen.main_menu.label_empty"), -41, -3, -11253961);
		this.font.draw(poseStack,

				ReturnLevelProcedure.execute(), -3, -20, -12829636);
		this.font.draw(poseStack,

				ReturnSpecialProcedure.execute(), -3, -11, -12829636);
		this.font.draw(poseStack,

				ReturnStrengthProcedure.execute(), -41, 5, -12829636);
		this.font.draw(poseStack,

				ReturnHealthProcedure.execute(), -41, 14, -12829636);
		this.font.draw(poseStack,

				ReturnCursedEnergyProcedure.execute(), -41, 23, -12829636);
		this.font.draw(poseStack,

				ReturnEnergyControlProcedure.execute(entity), -41, 32, -12829636);
		this.font.draw(poseStack,

				ReturnSpeedProcedure.execute(), -41, 41, -12829636);
