...
public class MainMenuScreen extends AbstractContainerScreen<MainMenuMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 72 && mouseX < leftPos + 92 && mouseY > topPos + 45 && mouseY < topPos + 54)
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.leftPos + -160, this.topPos + -111, 0, 0, 322, 220, 322, 220);
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack,
				...
				ReturnCursedEnergyProcedure.execute(entity), -45, 23, -12829636);
		this.font.draw(poseStack,

				ReturnEnergyControlProcedure.execute(entity), -45, 32, -12829636);
		this.font.draw(poseStack,

				ReturnSpeedProcedure.execute(entity), -45, 41, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.craft_kaisen.main_menu.label_empty1"), 78, -60, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.craft_kaisen.main_menu.label_empty2"), 80, 4, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.craft_kaisen.main_menu.label_empty3"), 80, 14, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.craft_kaisen.main_menu.label_empty4"), 80, 24, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.craft_kaisen.main_menu.label_empty5"), 80, 34, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.craft_kaisen.main_menu.label_empty6"), 80, 44, -12829636);
	}
	...
	public void init() {
		...
		imagebutton_button1png = new ImageButton(this.leftPos + 71, this.topPos + -61, 23, 12, 0, 0, 12, new ResourceLocation("craft_kaisen:textures/screens/atlas/imagebutton_button1png.png"), 23, 24, e -> {
			if (true) {
		...
		imagebutton_smallbutton1png = new ImageButton(this.leftPos + 72, this.topPos + 5, 20, 10, 0, 0, 10, new ResourceLocation("craft_kaisen:textures/screens/atlas/imagebutton_smallbutton1png.png"), 20, 20, e -> {
			if (true) {
		...
		imagebutton_smallbutton1png1 = new ImageButton(this.leftPos + 72, this.topPos + 14, 20, 10, 0, 0, 10, new ResourceLocation("craft_kaisen:textures/screens/atlas/imagebutton_smallbutton1png1.png"), 20, 20, e -> {
			if (true) {
		...
		imagebutton_smallbutton1png3 = new ImageButton(this.leftPos + 72, this.topPos + 34, 20, 10, 0, 0, 10, new ResourceLocation("craft_kaisen:textures/screens/atlas/imagebutton_smallbutton1png3.png"), 20, 20, e -> {
			if (true) {
		...
		imagebutton_smallbutton1png2 = new ImageButton(this.leftPos + 72, this.topPos + 24, 20, 10, 0, 0, 10, new ResourceLocation("craft_kaisen:textures/screens/atlas/imagebutton_smallbutton1png2.png"), 20, 20, e -> {
			if (true) {
		...
		imagebutton_smallbutton1png4 = new ImageButton(this.leftPos + 72, this.topPos + 44, 20, 10, 0, 0, 10, new ResourceLocation("craft_kaisen:textures/screens/atlas/imagebutton_smallbutton1png4.png"), 20, 20, e -> {
			if (true) {
