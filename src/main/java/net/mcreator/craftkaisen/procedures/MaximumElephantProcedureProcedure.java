...
if (!.contains("Maximum Elephant")) {if (!(((Entity) world.getEntitiesOfClass(MaximumElephantEntity.class,
...
if (((Entity) world.getEntitiesOfClass(MaximumElephantEntity.class,
...
_entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN,15,250, false, false));}else if (((Entity) world.getEntitiesOfClass(MaximumElephantEntity.class,
AABB.ofSize(new Vec3(x, y, z), 5000, 5000, 5000), e -> true)
.stream().sorted(new Object() {
Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
...
? _tamIsTamedBy.isOwnedBy(_livEnt):false) {if(!((Entity) world.getEntitiesOfClass(MaximumElephantEntity.class,
AABB.ofSize(new Vec3(x, y, z), 5000, 5000, 5000), e -> true)
.stream().sorted(new Object() {
Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
}
}.compareDistOf(x, y, z)).findFirst().orElse(null)).level.isClientSide()) ((Entity) world.getEntitiesOfClass(MaximumElephantEntity.class,
AABB.ofSize(new Vec3(x, y, z), 5000, 5000, 5000), e -> true)
.stream().sorted(new Object() {
Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
