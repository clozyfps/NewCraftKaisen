				...
				if (!(entity == entityiterator)) {
					if (!(immediatesourceentity == entityiterator)) {
						if (!entityiterator.getPersistentData().getBoolean("crush")) {
							...
							if (world instanceof ServerLevel _level)
								_level.sendParticles((SimpleParticleType) (CraftKaisenModParticleTypes.DELETED_MOD_ELEMENT.get()), (entityiterator.getX()), (entityiterator.getY()), (entityiterator.getZ()), 10, 3, 3, 3, 1);
